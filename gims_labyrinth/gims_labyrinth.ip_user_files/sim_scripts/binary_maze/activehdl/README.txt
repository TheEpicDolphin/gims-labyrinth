...
#
# Generated by export_simulation on Thu Nov 28 16:44:48 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './binary_maze.sh' script.

./binary_maze.sh -reset_run
...
./binary_maze.sh -noclean_files

For more information on the script, please type './binary_maze.sh -help'.
