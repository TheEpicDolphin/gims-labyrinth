...
#
# Generated by export_simulation on Thu Dec 05 15:01:10 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './cam_image_buffer.sh' script.

./cam_image_buffer.sh -reset_run
...
./cam_image_buffer.sh -noclean_files

For more information on the script, please type './cam_image_buffer.sh -help'.
