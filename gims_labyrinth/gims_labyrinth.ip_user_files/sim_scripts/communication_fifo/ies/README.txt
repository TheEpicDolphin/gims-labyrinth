...
#
# Generated by export_simulation on Fri Dec 06 12:45:55 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './communication_fifo.sh' script.

./communication_fifo.sh -reset_run
...
./communication_fifo.sh -noclean_files

For more information on the script, please type './communication_fifo.sh -help'.
