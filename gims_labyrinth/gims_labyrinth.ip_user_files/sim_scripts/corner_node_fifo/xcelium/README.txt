...
#
# Generated by export_simulation on Wed Nov 27 03:26:50 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './corner_node_fifo.sh' script.

./corner_node_fifo.sh -reset_run
...
./corner_node_fifo.sh -noclean_files

For more information on the script, please type './corner_node_fifo.sh -help'.
