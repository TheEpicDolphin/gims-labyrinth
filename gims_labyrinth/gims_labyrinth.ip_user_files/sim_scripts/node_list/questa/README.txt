...
#
# Generated by export_simulation on Sat Nov 16 15:41:20 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './node_list.sh' script.

./node_list.sh -reset_run
...
./node_list.sh -noclean_files

For more information on the script, please type './node_list.sh -help'.
