...
#
# Generated by export_simulation on Tue Nov 19 16:24:07 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './spt_min_weights.sh' script.

./spt_min_weights.sh -reset_run
...
./spt_min_weights.sh -noclean_files

For more information on the script, please type './spt_min_weights.sh -help'.
