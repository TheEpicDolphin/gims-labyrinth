...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims_labyrinth/gims_labyrinth.runs/adjacency_list_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adjacency_list.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adjacency_list.tcl
