...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims-labyrinth/gims_labyrinth/gims_labyrinth.runs/binary_maze_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_maze.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binary_maze.tcl
