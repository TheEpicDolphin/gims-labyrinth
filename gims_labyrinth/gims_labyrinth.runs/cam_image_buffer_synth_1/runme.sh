...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims-labyrinth/gims_labyrinth/gims_labyrinth.runs/cam_image_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam_image_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam_image_buffer.tcl
