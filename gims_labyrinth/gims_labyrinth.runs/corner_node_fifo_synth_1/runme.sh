...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims-labyrinth/gims_labyrinth/gims_labyrinth.runs/corner_node_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log corner_node_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source corner_node_fifo.tcl
