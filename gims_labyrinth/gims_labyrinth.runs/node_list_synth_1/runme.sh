...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims_labyrinth/gims_labyrinth.runs/node_list_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log node_list.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source node_list.tcl
