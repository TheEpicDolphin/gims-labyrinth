...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims-labyrinth/gims_labyrinth/gims_labyrinth.runs/path_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log path_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source path_bram.tcl
