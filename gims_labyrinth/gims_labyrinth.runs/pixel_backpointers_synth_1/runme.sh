...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims-labyrinth/gims_labyrinth/gims_labyrinth.runs/pixel_backpointers_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_backpointers.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_backpointers.tcl
