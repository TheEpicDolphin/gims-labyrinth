...
HD_PWD='C:/Users/giand/Documents/MIT/Senior_Fall/6.111/gims_labyrinth/gims_labyrinth.runs/spt_min_weights_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spt_min_weights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spt_min_weights.tcl
