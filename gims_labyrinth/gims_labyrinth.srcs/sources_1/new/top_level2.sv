...
module final_proj(
   ...
   output[7:0] an    // Display location 0-7
    ...
    logic my_valid_pixel;
    cam_image_buffer jojos_bram(.addra(pixel_addr_in), 
                             .clka(pclk_in),
    ...
    //added by viv  
    logic full;   
    assign my_valid_pixel = valid_pixel;  
    always_ff @(posedge pclk_in)begin
        if (frame_done_out)begin
            ...
            //if (pixel_addr_in == my_maze_pixel_addr) 
                //my_maze_pixel_data<= {output_pixels[15:12],output_pixels[10:7],output_pixels[4:1]};
        end
    end
